...
CREATE TABLE `aktifitas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idpenempatan` int(11) NOT NULL,
  `latitude` decimal(10,8) DEFAULT NULL,
  `longitude` decimal(11,8) DEFAULT NULL,
  `uraian` text DEFAULT NULL,
  `waktu` datetime DEFAULT NULL,
  `jummhs` smallint(6) DEFAULT 1,
  `jummasyarakat` smallint(6) DEFAULT 0,
  `grup` enum('Non Fisik','Fisik') DEFAULT 'Non Fisik',
  `estbiaya` int(11) DEFAULT 0,
  `owned` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `iduser_update` int(11) DEFAULT NULL,
  `update` datetime DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=91932 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `aktifitas_dpl` (
  ...
  `fileinfo` text CHARACTER SET latin1 DEFAULT NULL,
  `waktu` datetime DEFAULT NULL,
  `owned` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `iduser_update` int(11) DEFAULT NULL,
...
CREATE TABLE `aktifitas_komentar` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idaktifitas` int(11) DEFAULT NULL,
  `iduser` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=19220 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=124911 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `berkas_administrasi` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idadministrasi` int(11) DEFAULT NULL,
...
CREATE TABLE `kelompok` (
  ...
  `idpembimbing_kkn` int(11) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=70226 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `nilai` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idpenempatan` int(11) DEFAULT NULL,
  `idmst_penilaian` int(11) DEFAULT NULL,
...
CREATE TABLE `notifikasi` (
  ...
  `idaktifitas` int(11) DEFAULT NULL,
  `iduser` int(11) DEFAULT NULL,
  `iduser_asal` int(11) DEFAULT NULL,
  `notif` varchar(350) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pembimbing_kkn` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idsk_pembimbing` int(11) DEFAULT NULL,
  `idpembimbing` int(11) DEFAULT NULL,
  `keterangan` varchar(200) DEFAULT NULL,
  `owned` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `iduser_update` int(11) DEFAULT NULL,
...
CREATE TABLE `posko` (
  ...
  `path` varchar(300) CHARACTER SET latin1 DEFAULT NULL,
  `fileinfo` text CHARACTER SET latin1 DEFAULT NULL,
  `proker` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `owned` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `iduser_update` int(11) DEFAULT NULL,
  `update` datetime DEFAULT NULL,
...
CREATE TABLE `profil` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `detail` text DEFAULT NULL,
  `idjenis_profil` int(11) DEFAULT NULL,
  `thumbnail` varchar(300) DEFAULT NULL,
  `fileinfo` text DEFAULT NULL,
  `owned` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
...
CREATE TABLE `wilayah_kab` (
  ...
  `idwilayah_jenis` int(11) DEFAULT NULL,
  `owned` int(11) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `iduser_update` int(11) DEFAULT NULL,
  `update` datetime DEFAULT NULL,
...
-- Dump completed on 2023-03-05  7:06:56
